...
public class yonler6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yonler6);
    ...
    public void yonler7gecis(View view){
        if(onnclicked){
            onSkor++;
        }
        Intent intent = new Intent(yonler6.this,yonler7.class);
