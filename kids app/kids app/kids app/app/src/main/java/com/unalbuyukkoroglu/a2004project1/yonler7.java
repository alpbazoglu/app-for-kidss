...
public class yonler7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yonler7);
    ...
    public void yonler8gecis(View view){
        if(arkaclicked){
            arkaSkor++;
        }
        Intent intent = new Intent(yonler7.this,yonler8.class);
